...
public class RedisUtil {
	 ...
	 * @Author qiangqiang.sun@seaboxdata.com
	 * @Description HSCAN key cursor [MATCH pattern] [COUNT count]
	 * 如果Hash中的F-V对的数量小于512，并且所有的V的长度都比较短，HSCAN命令会一次遍历出该KEY的所有的F-V对
	 * @Date 2021/4/7 11:34
	 * @Param key 键
	 * @Param pattern 正则表达式
	 * @Param count 数量
	 **/
	public Map<String, Object> hScan(String key, String pattern, int count) {
		Map<String, Object> result = new HashMap<>();
		BoundHashOperations<String, String, Object> boundHashOps = redisTemplate.boundHashOps(key);
		try (Cursor<Map.Entry<String, Object>> cursor = boundHashOps.scan(
			...
			log.error("class:RedisUtils method:hScan() => Exception {}", e);
		}
		return result;
	}
